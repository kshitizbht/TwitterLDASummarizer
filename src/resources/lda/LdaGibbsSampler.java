...
public class LdaGibbsSampler implements Serializable { 
	...
	private static final long serialVersionUID = 3280046536436164544L;
    /**
     ...
     * @param data
     */
    public LdaGibbsSampler(int[][] documents, int V, boolean debug) {
    ...
    public void initialState(int K) {
        ...
        for (int m = 0; m < M; m++) {
        	//TODO
        	//Make it ignore after last value which is -1
            int N = getLengthOfTweet(documents[m]);
            z[m] = new int[N];
            for (int n = 0; n < N; n++) {
    ...
    public int getLengthOfTweet(int[] tweet){
    ...
    /**
     * Returns topic assignment of each word
     */
    public int[][] getWordperTweetAssignment(){
    	return z;
    }
     ...
     * cwt[i][j] number of instances of word i (term?) assigned to topic j.
     */
    public int[][] getWordTopicAssociation(){
    	return nw;
    }
     ...
     * nwsum[j] total number of words assigned to topic j.
     */
    public int[] getWordsAssignedtoTopic(){
    	return nwsum;
    }
    /**
    ...
    public static void main(String[] args) {
        ...
        LdaGibbsSampler lda = new LdaGibbsSampler(documents, V,true);
